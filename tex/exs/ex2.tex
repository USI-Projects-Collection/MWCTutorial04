\section{Exercise 2 – Material Design}
    ...
    \subsection{Change App Icon}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.15\textwidth]{res/img/icon1.png}
            \hspace{0.05\textwidth}
            \includegraphics[width=0.15\textwidth]{res/img/icon2.png}      
            \hspace{0.05\textwidth}
            \includegraphics[width=0.15\textwidth]{res/img/icon3.png}
...
\subsection{Implement Dark Theme}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.15\textwidth]{res/img/dark_theme_switch.png}
    ...
    \lstinputlisting[firstline=45, lastline=56, firstnumber=45]{../app/src/main/java/com/example/stepappv4/ui/slideshow/ProfileFragment.java}
